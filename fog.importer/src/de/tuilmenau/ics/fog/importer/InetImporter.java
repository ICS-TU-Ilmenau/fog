...
import de.tuilmenau.ics.fog.importer.parser.TopologyParserInet;
import de.tuilmenau.ics.fog.topology.Simulation;

public class InetImporter extends BRITEImporter
{
	protected ITopologyParser createParser(String importFilename, Simulation simulation) throws Exception
	{
		return new TopologyParserInet(simulation.getLogger(), importFilename, useMeta());
	}
}
