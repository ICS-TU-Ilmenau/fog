...
import de.tuilmenau.ics.fog.importer.parser.TopologyParserNS;
import de.tuilmenau.ics.fog.topology.Simulation;

public class NSImporter extends BRITEImporter
{
	protected ITopologyParser createParser(String importFilename, Simulation simulation) throws Exception
	{
		return new TopologyParserNS(simulation.getLogger(), importFilename);
	}
